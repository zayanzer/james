...
zokou({
  ...
  if (!arg[0]) {
    repondre("insert video name Ie. _video hozambee by 𝚓𝚊𝚖𝚎𝚜 ft shifura._");
    return;
  }
...
\n\n\n ©𝚂𝙸𝚁 *𝙹𝙰𝙼𝙴𝚂*`
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "©𝙹𝙰𝙼𝙴𝚂 𝙼𝙳", gifPlayback: false }, { quoted: ms });
      });
