...
module.exports = { session: process.env.SESSION_ID || 'MUSTAFFA-MK;;;',
    PREFIXE: process.env.PREFIX || "+",
    CHAT_BOT : process.env.CHAT_BOT|| "non",
    OWNER_NAME : process.env.OWNER_NAME || "Mustaffa Mk",
    ...
    GURL: process.env.GURL  || "https://whatsapp.com/channel/0029VawBbI40AgWKACOjdm1T",
    WEBSITE :process.env.GURL || "https://whatsapp.com/channel/0029VawBbI40AgWKACOjdm1T",
    CAPTION : process.env.CAPTION || "ᴘᴏᴡᴇʀᴇᴅ ʙʏ MUSTAFFA-MK",
    BOT : process.env.BOT_NAME || 'MUSTAFFA-MK',
